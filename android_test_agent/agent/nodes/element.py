...
class ElementNode:
    ...
    def _collect_element_sources(self) -> dict[str, Any]:
        ...
        with ThreadPoolExecutor(max_workers=2) as executor:
            ...
            results: dict[str, Any] = {"parallel_sources": ["ui_dump", "screenshot", "manual_mapping", "element_memory"]}
    ...
    def _collect_ui_dump(self) -> dict[str, Any]:
        ...
        return {"page_source": path.read_text(encoding="utf-8"), "ui_dump_path": str(path)}
